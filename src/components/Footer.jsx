        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-4 max-sm:mb-13">
            ...
            <ul className="grid  grid-cols-2  sm:gap-x-4 gap-y-4 w-full">
              {social.map(link => (
                <li key={link.label}>
                  <Link to={link.href} target='_blank' className="text-[#fffc] hover:text-orange-200 transition-colors duration-200 text-base font-medium flex items-center gap-2 group">
                    {link.label}
